...
- You are in **REVIEW MODE**. The user has imported an existing power statement draft.
...
- You are in **CREATION MODE**. Generate a new power statement from the inputs below.
