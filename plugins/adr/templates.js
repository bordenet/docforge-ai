...
export const TEMPLATES = [
  ...
  },
  {
    ...
    fields: {
      ...
      status: 'proposed',
      context:
        'We need to select [technology type] for [project/system].\n\nRequirements:\n- [Requirement 1]\n- [Requirement 2]\n\nConstraints:\n- Team expertise in [languages/frameworks]\n- Integration with [existing systems]',
  ...
  },
  {
    ...
    fields: {
      ...
      status: 'proposed',
      context:
        'Current deployment process has the following issues:\n- [Issue 1]\n- [Issue 2]\n\nGoals:\n- Reduce deployment time from [X] to [Y]\n- Enable [capability]',
      decision:
        'We will implement [strategy] using [tools].\n\nKey components:\n- [Component 1]\n- [Component 2]',
      consequences:
  ...
  },
  {
    ...
    fields: {
      ...
      status: 'proposed',
      context:
        'We need to design APIs for [system/service].\n\nConsumers:\n- [Consumer 1]\n- [Consumer 2]\n\nRequirements:\n- [Performance requirement]\n- [Compatibility requirement]',
      decision:
        'We will use [REST/GraphQL/gRPC] with the following patterns:\n- [Pattern 1]\n- [Pattern 2]\n- [Pattern 3]',
      consequences:
  ...
  },
  {
    ...
    fields: {
      ...
      status: 'proposed',
      context:
        'We need to migrate data from [source] to [target].\n\nData volume: [size]\nDowntime tolerance: [requirement]\nData integrity requirements: [requirements]',
      decision:
        'We will use [migration strategy] with the following approach:\n1. [Step 1]\n2. [Step 2]\n3. [Step 3]\n\nRollback plan: [description]',
      consequences:
