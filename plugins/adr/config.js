...
export const adrPlugin = {
  ...
  scoringDimensions: [
    ...
    { name: 'Status', maxPoints: 25, description: 'Clear status (proposed/accepted/deprecated/superseded)' }
  ],
  ...
  workflowConfig: {
    phaseCount: 3,
    phases: [
      { number: 1, name: 'Initial Draft', icon: '📝', aiModel: 'Claude', description: 'Generate the first ADR draft' },
      { number: 2, name: 'Technical Review', icon: '🔍', aiModel: 'Gemini', description: 'Get technical perspective from Gemini' },
      { number: 3, name: 'Final ADR', icon: '✨', aiModel: 'Claude', description: 'Combine into polished ADR' }
    ]
  }
};
