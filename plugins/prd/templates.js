...
export const TEMPLATES = [
  ...
  },
  {
    ...
    fields: {
      ...
      problem:
        'Users currently face [pain point] when trying to [task].\n\nEvidence:\n- [User research finding 1]\n- [Support ticket trend]\n- [Competitor analysis]',
      userPersona:
        'Primary: [Persona name] - [Role/demographic]\nSecondary: [Persona name] - [Role/demographic]\n\nJobs to be done:\n- [JTBD 1]\n- [JTBD 2]',
      context:
        'Strategic alignment: [Company initiative]\nMarket timing: [Why now]\nDependencies: [Related projects/systems]',
      goals:
