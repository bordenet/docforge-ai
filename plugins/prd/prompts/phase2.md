...
- **Feature (1-3 pages):** Single capability. Expect 8-10 sections, not full 16.
- **Epic (4-8 pages):** Multi-feature initiative. Expect all 16 sections, concise.
- **Product (8-15 pages):** New product/platform. Expect full 16 sections + appendices.
...
**If the Phase 1 document contains sections marked `[TO BE EXPANDED]`:**

These stubs are **intentional user choices** to keep the document concise. The user explicitly chose to stub out these sections during Phase 1's length checkpoint.

**Your obligations:**
1. ✅ **PRESERVE stubs exactly as written** - Do NOT expand or fill in stub content
2. ✅ **Review only non-stubbed sections** - Focus your critique on the complete sections
3. ✅ **Acknowledge stubs in your review** - Note that X sections are intentionally stubbed
4. ❌ **DO NOT expand stubs** - Even if you could add valuable content
5. ❌ **DO NOT flag stubs as "missing content"** - They are placeholders, not gaps

**Example stub format to preserve:**
```markdown
...
Evaluate the **16 required sections** (per Phase1.md):
| Weight | Section |
|--------|---------|
...
| 2 pts | Competitive Landscape |
| 2 pts | Proposed Solution |
| 2 pts | Requirements |
| 1.5 pts | Scope |
| 1.5 pts | User Personas |
...
- Customer FAQ appears BEFORE Competitive Landscape and Proposed Solution (Working Backwards)
