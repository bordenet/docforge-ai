...
export const TEMPLATES = [
  ...
  },
  {
    ...
    fields: {
      ...
      problem:
        'Customers today struggle with [specific pain point] when trying to [accomplish goal].\n\nThis results in:\n- [Negative outcome 1]\n- [Negative outcome 2]\n- [Quantified impact]',
      solution:
        '[Company] announces [Product Name], a [category] that [core value proposition].\n\nKey capabilities:\n- [Capability 1]\n- [Capability 2]\n- [Capability 3]',
      customerQuote:
        '"Before [Product], I spent [time/effort] on [task]. Now I can [benefit] in [fraction of time]. It\'s changed how I [activity]." - [Customer Name], [Title] at [Company]',
      internalFaq:
  ...
  },
  {
    ...
    fields: {
      ...
      problem:
        'Teams currently spend [X hours/week] on [manual process], leading to:\n- Inconsistent [outcomes]\n- Delayed [deliverables]\n- [Quantified productivity loss]',
      solution:
        '[Platform Name] is an internal platform that enables teams to [core capability].\n\nFeatures:\n- [Feature 1]: [Benefit]\n- [Feature 2]: [Benefit]\n- [Feature 3]: [Benefit]',
      customerQuote:
        '"[Platform] has transformed how our team operates. What used to take [old time] now takes [new time], and the quality is more consistent." - [Name], [Team]',
      internalFaq:
        '- Who will maintain this platform?\n- How will we handle onboarding?\n- What is the migration path from current tools?\n- What is the cost of development vs. buy?\n- How will we measure adoption?',
      metrics:
        '- Time saved: [X] hours/week per team\n- Adoption: [X]% of target teams in [timeframe]\n- Error reduction: [X]%\n- Developer satisfaction: [X] score',
    },
  },
  {
    ...
    fields: {
      ...
      problem:
        'Current [process/policy] creates friction:\n- [Pain point 1]\n- [Pain point 2]\n\nImpact: [Quantified business impact]',
      solution:
        '[Company] introduces [Initiative Name], a new approach to [area] that [key change].\n\nKey changes:\n- [Change 1]\n- [Change 2]\n- [Change 3]',
      customerQuote:
        '"The new [process] is so much simpler. I no longer have to [old pain point], and I can focus on [value-add activity]." - [Name], [Role]',
      internalFaq:
