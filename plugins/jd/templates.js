...
export const TEMPLATES = [
  ...
  },
  {
    ...
    fields: {
      ...
      department: 'Product',
      level: 'senior',
      teamContext: 'Join our [product area] team shaping the future of [product/experience]. You\'ll own the roadmap for [specific area] impacting [X] users.\n\nYou\'ll drive:\n- Product strategy and roadmap\n- Cross-functional delivery\n- Customer research and insights',
  ...
  },
  {
    ...
    fields: {
      ...
      department: 'Engineering',
      level: 'manager',
      teamContext: 'Lead our [team name] team of [X] engineers building [product/system]. You\'ll be responsible for [scope] while growing and developing your team.\n\nYou\'ll own:\n- Team performance and delivery\n- Hiring and talent development\n- Technical strategy and execution',
